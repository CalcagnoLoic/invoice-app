...
| -------------------------------- | -------------------------------------------- |
| ![](public/assets/img/form.png)  | ![](public/assets/img/detail.png)            |

| An user can update an existed invoice | An user can delete an existed invoice |
| ------------------------------------- | ------------------------------------- |
| ![](public/assets/img/editform.png)   | ![](public/assets/img/delete.png)     |

| Light Mode                        | Dark Mode                           |
| --------------------------------- | ----------------------------------- |
| ![](public/assets/img/readme.png) | ![](public/assets/img/darkmode.png) |
